...
public class Ville extends Model{
	...
	public Ville(String nom_ville, String histo_ville, float lat_ville, float long_ville, long code_postal){
	...
	public Ville(String nom_ville, float lat_ville, float long_ville, long code_postal){
		this(nom_ville, null, lat_ville, long_ville, code_postal);
	}
}
